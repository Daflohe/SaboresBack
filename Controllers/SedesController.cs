...
namespace Sabores_Backend.Controllers
{
    ...
    public class SedesController : ControllerBase
    {
        ...
        public SedesController(SaboresContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Sede>> PostSede(Sede sede)
        {
          if (_context.Sedes == null)
          {
              return Problem("Entity set 'SABORESContext.Sedes'  is null.");
          }
        ...
        {
            return (_context.Sedes?.Any(e => e.IdSede == id)).GetValueOrDefault();
        }
    }
}
